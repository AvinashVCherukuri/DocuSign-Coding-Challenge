...
Execution: Use python3 interpreter for running the code. You can give any number of arguments. 
		   Example 1: python3 LoadBalancer.py A:7 V:3 Example 2: python3 LoadBalancer.py H:2 E:6 Y:9.
...
# Verify whether each argument is in the right format of ServerName:LoadCapacity. 
# If any of the arguments are not in the correct format then exit the program.
...
# to print weighted random ServerNames in the form of a string.
